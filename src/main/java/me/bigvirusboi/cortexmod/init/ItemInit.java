...
import me.bigvirusboi.cortexmod.item.CortexCreativeModeTab;
...
public class ItemInit {
    ...
    public static final RegistryObject<Item> BANANA = ITEMS.register("banana", () ->
            new Item(new Item.Properties().food(new FoodProperties.Builder()
                    ...
                    .tab(CortexCreativeModeTab.TAB_CORTEX)));

    public static final RegistryObject<BlockItem> KODY_BLOCK = ITEMS.register("kody_block", () ->
            new BlockItem(BlockInit.KODY_BLOCK.get(), new Item.Properties().tab(CortexCreativeModeTab.TAB_CORTEX)));
}
